...
class Zombie:
    ...
    def __init__(self, x=None, y=None):
        ...
        self.patrol_locaiton = [(43,274),(1118,274),(575,804),(235,991),(575,804),(1050,494)]
        self.loc_no = 0
    ...
    def get_patrol_location(self):
        self.tx,self.ty = self.patrol_locaiton[self.loc_no]
        self.loc_no = (self.loc_no +1) % len(self.patrol_locaiton)
        return BehaviorTree.SUCCESS
        pass
    ...
    def build_behavior_tree(self):
        ...
        c2 = Condition('공 갯수가 소년보다 좀비가 많은가?', self.is_boy_ball_less)
        SEQ_chase_or_run = Sequence('계속 추적',c2,a4)

        SEQ_chase_boy = Sequence('소년을 추적',c1,SEQ_chase_or_run)
